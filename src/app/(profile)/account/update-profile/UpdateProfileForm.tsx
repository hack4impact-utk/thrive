...
const KNOWN_REFERRAL_VALUES = new Set([
  "friend_or_family",
  "church",
  "social_media",
  "community_event",
...
export default function UpdateProfileForm({
  ...
  const isKnownReferral = KNOWN_REFERRAL_VALUES.has(
    initialValues.referralSource,
  );

  const [form, setForm] = React.useState<UpdateProfileFormState>({
    ...
    phoneNumber: initialValues.phoneNumber.replaceAll(/\D/g, ""),
    birthMonth: String(initialValues.birthMonth),
    birthDay: String(initialValues.birthDay),
    birthYear: String(initialValues.birthYear),
    preferredNeighborhood: initialValues.preferredNeighborhood,
    gender: initialValues.gender,
    shirtSize: initialValues.shirtSize,
    referralSource: isKnownReferral ? initialValues.referralSource : "other",
    referralSourceOther: isKnownReferral ? "" : initialValues.referralSource,
  ...
  return (
    <FormLayout
      ...
      description="* indicates required field. All required fields must be filled out to save your changes."
